...
import 'schema/bug_report_record.dart';
...
export 'schema/bug_report_record.dart';
...
Future<int> queryFeatureRequestRecordCount({
  ...
  int limit = -1,
    ...
    queryCollectionCount(
      FeatureRequestRecord.collection(parent),
      queryBuilder: queryBuilder,
      limit: limit,
    );
...
Stream<List<FeatureRequestRecord>> queryFeatureRequestRecord({
  ...
  bool singleRecord = false,
    ...
    queryCollection(
      FeatureRequestRecord.collection(parent),
      FeatureRequestRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );
...
Future<int> queryBugReportRecordCount({
  ...
  int limit = -1,
    ...
    queryCollectionCount(
      BugReportRecord.collection(parent),
      queryBuilder: queryBuilder,
      limit: limit,
    );
...
Future<int> queryAppRatingRecordCount({
  ...
  int limit = -1,
    ...
    queryCollectionCount(
      AppRatingRecord.collection(parent),
      queryBuilder: queryBuilder,
      limit: limit,
    );
