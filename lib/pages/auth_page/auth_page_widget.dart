                                    ...
                                    tabs: [
                                      Tab(
                                        text: FFLocalizations.of(
                                          context,
                                        ).getText('g50ykatt' /* Sign In */),
                                      ),
                                      Tab(
                                        text: FFLocalizations.of(
                                          context,
                                        ).getText('dgopmpr3' /* Sign Up */),
                                      ),
                                    ],
