                  ...
                  children:
                      [
                            Text(
                              FFLocalizations.of(
                                context,
                              ).getText('a2ollfug' /* Choose your language */),
                            ...
                            FlutterFlowLanguageSelector(
                              ...
                              dropdownColor: FlutterFlowTheme.of(
                                context,
                              ).secondaryBackground,
                              dropdownIconColor: FlutterFlowTheme.of(
                                context,
                              ).secondaryText,
                              borderRadius: 12.0,
                              ...
                              flagSize: 24.0,
                              flagTextGap: 8.0,
                              currentLanguage: FFLocalizations.of(
                                context,
                              ).languageCode,
                            ...
                            FlutterFlowDropDown<int>(
                              ...
                              optionLabels: [
                                FFLocalizations.of(
                                  context,
                                ).getText('sg91yjho' /* Right Handed Signer */),
                                FFLocalizations.of(
                                  context,
                                ).getText('u72icawo' /* Left Hnaded Signer */),
                                FFLocalizations.of(
                                  context,
                                ).getText('qky9ny2q' /* Ambidextrous */),
                              ],
