  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<UsersRecord>(
      ...
      builder: (context, snapshot) {
        ...
        _model.debugBackendQueries['supportPageUsersRecord_Scaffold_tm035sr4'] =
            debugSerializeParam(
          supportPageUsersRecord,
          ParamType.Document,
          link:
              'https://app.flutterflow.io/project/signify-hq88od?tab=uiBuilder&page=supportPage',
          name: 'users',
          nullable: false,
        );
        debugLogWidgetClass(_model);
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                FFLocalizations.of(context).getText(
                                  '5vhrmfnu' /* We're here to help! Choose how... */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                            ...
                            children: [
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  await AppRatingRecord.createDoc(
                                          supportPageUsersRecord.reference)
                                      .set(createAppRatingRecordData(
                                  ...
                                  children: [
                                    Row(
                                      ...
                                      children: [
                                        Text(
                                          FFLocalizations.of(context).getText(
                                            '30slela1' /* How do I reset my password? */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .bodyLarge
                                              .override(
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        Text(
                                          FFLocalizations.of(context).getText(
                                            'm8magthq' /* How do I update my profile? */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .bodyLarge
                                              .override(
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        Text(
                                          FFLocalizations.of(context).getText(
                                            'r9r6xjbs' /* How do I change my email? */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .bodyLarge
                                              .override(
